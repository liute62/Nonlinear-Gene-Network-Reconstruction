# source this code to conduct the General Dependency Hiararchical CLustering
...
gdhc<-function(array, hamil.method="nn", concorde.path=NA, use.normal.approx=FALSE, normalization="standardize", combine.linear=TRUE, use.traditional.hclust=FALSE, method.traditional.hclust="average")
{
	library(TSP)
